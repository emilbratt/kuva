...
27 plot types, one figure — generated by running `cargo run --example all_plots_simple` and `cargo run --example all_plots_complex`.

**Simple overview** (compact, minimal data):

![All 25 plot types — simple](./assets/overview/all_plots_simple.svg)

**Full-featured** (larger datasets, titles, axis labels, legends):

![All 25 plot types — complex](./assets/overview/all_plots_complex.svg)
